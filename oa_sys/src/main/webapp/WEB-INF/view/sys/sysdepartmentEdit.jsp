...
<form class="layui-form linksAdd">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="description" value="${sysdepartment.description}" class="layui-input" lay-verify="required" placeholder="请输入机构的描述信息" />
        </div>
    </div>
    <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    var path = "${path}";
    var parentdepartmentid = ${sysdepartment.parentdepartmentid};
