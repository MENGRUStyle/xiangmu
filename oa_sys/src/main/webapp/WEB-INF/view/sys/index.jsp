            ...
            <ul class="layui-nav beg-layout-nav" lay-filter="user">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" data-tab="true" data-url='${path}/user/personInfo'>
                                <i class="fa fa-user-circle" aria-hidden="true"></i>
                                <cite>个人信息</cite>
                            </a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-tab="true" data-url="/user/personInfo">
        ...
        <div class="layui-tab layui-tab-brief layout-nav-card" lay-filter="layout-tab" style="border: 0; margin: 0;box-shadow: none; height: 100%;">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe src="${path }/index/main"></iframe>
                </div>
            </div>
        </div>
    </div>
